...
import Workingwitharray from "./Workingwitharray";
export default function Content()
    {
return(
    <div style={{backgroundColor:'lightblue',color:'black',justifyContent:'center',border:'2px black solid',
     height:'500px' , width:'80%',wordSpacing:'2px' , margin:'2px'}}>
      ...
      blame belongs to those who fail in their duty through weakness
       of will, which is the same as saying through shrinking from toil
        ...
        untrammelled and when nothing prevents our being able to do what
         ...
         <div>
            <Workingwitharray></Workingwitharray>
         </div>
